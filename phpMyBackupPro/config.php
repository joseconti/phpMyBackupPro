...
function PMBP_config_print($item) {
    ...
    if (isset($checkbox[$item])) {
        ...
        $out="<input type=\"password\" size=\"10\" name=\"".$item."\" value=\"".$confItem."\"".PMBP_config_disable($item).">";
        ...
        $out="<input type=\"text\" size=\"10\" name=\"".$item."\" value=\"".$confItem."\"".PMBP_config_disable($item)."><br>";
    }
    return $out;
}
