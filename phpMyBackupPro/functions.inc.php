 ...
 <tr>
  ...
  echo "</div>\n<div id=\"help\">\n";
    ...
    if (!($CONF['no_login']=="1" && $CONF['login']=="0")) {
    	echo "\n<a href=\"http://flattr.com/thing/464503/phpMyBackupPro-the-MySQL-backup-tool\" target=\"_blank\" style=\"position:relative; left:-70px\">\n<img src=\"http://api.flattr.com/button/flattr-badge-large.png\" alt=\"Flattr this\" title=\"Flattr this\" border=\"0\" /></a>";
    ...
    if ($con=PMBP_mysql_connect()) {
        ...
        if (!$error) {
            ...
            foreach($all_views as $row) {
            	$tablename=$row['Name'];
            	$res4=mysql_query("show create view `".$tablename."`");
            	if($res4) {
